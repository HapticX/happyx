...
export type TServerPathCB = (serverId: number, path: string, callback: any) => any;
...
export interface TCore {
     ...
     */
    hpxServer: (address: string, port: number) => number,
    ...
    hpxServerRoute: (serverId: number, httpMethods: Array<string>, path: string, callback: any) => void,
