...
translatable:
  ...
  "HappyX Application 🍍":
    ...
    "zh" -> "幸福应用"
    "ko" -> "HappyX 응용 프로그램🍍"
    "fr" -> "Une application pour Happ"
  "📕 API Docs":
    "ru" -> "📕 Документы по API"
    "ja" -> "📕 APIドキュメント"
    "zh" -> "📕 API文档"
    "ko" -> "📕 API 문서"
    "fr" -> "Doc Documentation de l'API"
  "Before you begin, please make sure you have":
    "ru" -> "Прежде чем вы начнете, пожалуйста, убедитесь, что у вас есть"
    "ja" -> "始める前に、持っていることを確かめて下さい"
    "zh" -> "在开始之前，请确保您有"
    "ko" -> "당신이 시작하기 전에,당신이 가지고 있는지 확인하십시오"
  ...
  "There is our first application. I show you ":
    "ru" -> "Вот наше первое приложение. Я покажу тебе "
