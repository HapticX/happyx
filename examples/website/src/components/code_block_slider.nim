        ...
        for idx in 0..<self.data.len:
          ...
          if idx == 0:
            tDiv(
              ...
              class =
                if self.column:
                  "w-full flex flex-col gap-4 lg:gap-2 justify-between transition-all duration-300 opacity-1"
                else:
                  "w-full flex flex-col lg:flex-row gap-4 lg:gap-2 justify-between transition-all duration-300 opacity-1"
            ):
            ...
            tDiv(
              ...
              class =
                if self.column:
                  "w-full flex flex-col gap-4 lg:gap-2 justify-between transition-all duration-300 absolute top-0 left-0 opacity-0"
                else:
                  "w-full flex flex-col lg:flex-row gap-4 lg:gap-2 justify-between transition-all duration-300 absolute top-0 left-0 opacity-0"
            ):
              tDiv(class = "flex flex-col gap-2 lg:gap-0"):
                tP(class = "break-keep whitespace-pre text-5xl lg:text-xl xl:text-3xl font-bold pointer-events-none"):
                  {translate(source.name)}
